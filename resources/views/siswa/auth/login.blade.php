...
<head>
    ...
    <title>Login Siswa - LPK Saitama</title>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-16">
            <div class="w-full max-w-md">
                ...
                <div class="mb-10 text-center lg:text-left">
                    ...
                    <p class="text-sm text-gray-500">Silakan masuk menggunakan email dan password akun siswa Anda.</p>
                </div>
                ...
                <div class="mt-8 text-center lg:text-left">
                    <p class="text-xs text-gray-500">
                        Belum memiliki akun? 
                        <a href="{{ route('siswa.register') }}" class="text-primer font-medium hover:underline">Daftar Sekarang</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="hidden lg:flex lg:w-1/2 relative bg-primer overflow-hidden items-center justify-center p-12">
            ...
            <div x-data="{ 
                ...
                <div x-show="activeSlide === 1" x-transition.opacity.duration.500ms class="space-y-6">
                    ...
                    <p class="text-white/80 leading-relaxed text-sm">Persiapkan dirimu untuk bekerja di Jepang bersama kami.</p>
                </div>
                @endforelse
