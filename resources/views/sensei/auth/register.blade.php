...
<head>
    ...
    <title>Daftar Akun Sensei - LPK Saitama</title>
...
<body class="font-sans antialiased text-gray-800 bg-white">
    ...
    <div class="flex min-h-screen">
        ...
        <div class="w-full lg:w-[60%] flex items-center justify-center p-8 sm:p-12 lg:p-16 overflow-y-auto">
            <div class="w-full max-w-lg">
                ...
                <div class="mb-8 text-center lg:text-left">
                    ...
                    <h1 class="text-2xl sm:text-3xl font-medium text-primer mb-2">Pendaftaran Sensei Baru</h1>
                    <p class="text-sm text-gray-500">Daftarkan akun Anda untuk mengakses sistem akademik LPK Saitama.</p>
                </div>
                ...
                <!-- Form Register -->
                <form action="{{ route('sensei.register') }}" method="POST" class="space-y-5">
                    @csrf
                    
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div class="sm:col-span-2">
                            <label for="nama_lengkap" class="block text-xs font-medium text-gray-700 mb-1.5 uppercase tracking-wide">Nama Lengkap</label>
                        ...
                        <div>
                            <label for="nomor_induk" class="block text-xs font-medium text-gray-700 mb-1.5 uppercase tracking-wide">Nomor Induk Pengajar</label>
                            <input type="text" id="nomor_induk" name="nomor_induk" value="{{ old('nomor_induk') }}" class="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-md focus:outline-none focus:border-primer focus:ring-1 focus:ring-primer focus:bg-white text-sm transition-colors" placeholder="Contoh: SENS-001" required>
                        </div>
                    ...
                    <div class="pt-2">
                        <div class="flex items-start">
                            ...
                            <label for="terms" class="ml-2 text-xs text-gray-600">
                                Saya mendaftar sebagai pengajar resmi dan menyetujui kebijakan privasi LPK Saitama.
                            </label>
                        </div>
                    </div>
                ...
                <div class="mt-8 text-center lg:text-left border-t border-gray-100 pt-6">
                    <p class="text-xs text-gray-500">
                        Sudah memiliki akun? 
                        <a href="{{ route('sensei.login') }}" class="text-primer font-medium hover:underline">Login di sini</a>
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="hidden lg:flex lg:w-[40%] relative bg-primer overflow-hidden items-center justify-center p-12">
            <!-- Background Ornaments -->
            <div class="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10 mix-blend-overlay"></div>
            <div class="absolute -top-24 -left-24 w-96 h-96 bg-sekunder/30 rounded-full blur-3xl"></div>
            ...
            <div x-data="{ 
                ...
                <div x-show="activeSlide === {{ $index + 1 }}" x-transition.opacity.duration.500ms @if($index > 0) style="display: none;" @endif class="space-y-6">
                    <div class="w-16 h-16 bg-white/10 rounded-md flex items-center justify-center border border-white/20 mb-6 backdrop-blur-sm shadow-sm">
                    ...
                    <h2 class="text-3xl font-medium leading-tight text-white">{{ $banner->judul }}</h2>
                ...
                <div x-show="activeSlide === 1" x-transition.opacity.duration.500ms class="space-y-6">
                    ...
                    <h2 class="text-3xl font-medium leading-tight text-white">Selamat Datang di LPK Saitama</h2>
